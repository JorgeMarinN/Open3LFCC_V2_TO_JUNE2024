...
plot vdb(ldo_out)
let LDOOUT_DB = vdb(ldo_out)
wrdata /foss/designs/Open3LFCC_V2/data/ldo_v2_sim_jm_checkRs2_vout-vs-vin.txt ac.v(ldo_out)
wrdata /foss/designs/Open3LFCC_V2/data/ldo_v2_sim_jm_checkRs2_psrr-voutdb.txt LDOOUT_DB
.endc
...
set wr_vecnames
set appendwrite
wrdata /foss/designs/Open3LFCC_V2/data/ldo_v2_sim_jm_checkRs2_vout-vs-vin-dc.txt dc.v(vdd) dc.v(ldo_out)
.endc
