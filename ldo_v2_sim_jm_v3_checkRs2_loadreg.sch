...
N 4090 -3760 4190 -3760 { lab=#net2}
...
N 3230 -3300 3230 -3280 { lab=#net3}
N 3230 -3130 3230 -3110 { lab=#net4}
N 3230 -3220 3230 -3210 { lab=#net5}
N 3230 -3150 3230 -3140 { lab=#net4}
N 3250 -3230 3250 -3180 { lab=GND}
N 3250 -3250 3250 -3230 { lab=GND}
N 3230 -3140 3230 -3130 { lab=#net4}
N 3230 -3050 3230 -3040 { lab=#net6}
...
N 3010 -3300 3010 -3280 { lab=#net3}
...
C {devices/opin.sym} 4430 -3720 0 0 {name=p3 lab=ldo_out
}
...
print load_reg
plot i(Vs)
wrdata /foss/designs/Open3LFCC_V2/data/ldo_v2_sim_jm_checkRs2_loadreg.txt tran.v(ldo_out) tran.i(vtest_ldoout)
.endc
...
C {devices/vsource.sym} 4400 -3720 1 0 {name=Vtest_ldoout value=0}
